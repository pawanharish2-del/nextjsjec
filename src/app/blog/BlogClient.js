                    ...
                    {featuredPost && (
                        <article className="blog-card featured">
                            <div className="blog-img-wrapper">
                                <Image src={featuredPost.image || "https://via.placeholder.com/800x400"} alt={featuredPost.title} width={800} height={400} style={{ objectFit: 'cover' }} unoptimized={true} />
                    ...
                    {filteredPosts.length > 0 ? (
                        displayedPosts.map((post) => (
                            <article className="blog-card" key={post.id}>
                                <div className="blog-img-wrapper">
                                    <Image src={post.image || "https://via.placeholder.com/600x300"} alt={post.title} width={600} height={300} style={{ objectFit: 'cover' }} unoptimized={true} />
                            ...
                            {posts.slice(0, 3).map(post => (
                                <li key={post.id}>
                                    ...
                                    <Link href={getPostLink(post)} className="recent-link">
                                        <Image src={post.image} className="recent-thumb" alt="thumb" width={80} height={80} style={{ objectFit: 'cover' }} unoptimized={true} />
                                        <div>

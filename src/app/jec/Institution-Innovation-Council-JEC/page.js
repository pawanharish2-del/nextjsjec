import IICContent from './IICContent';

export const metadata = {
    title: "Institution Innovation Council (IIC) | Jaipur Engineering College",
    ...
    openGraph: {
        title: "Institution Innovation Council (IIC) | Jaipur Engineering College",
        description: "Ministry of Human Resource Development (MHRD), Govt. of India has established ‘MHRD’s Innovation Cell (MIC)’ to systematically foster...",
        url: "https://www.jeckukas.org.in/jec/Institution-Innovation-Council-JEC",
        siteName: "Jaipur Engineering College",
        type: "website",
    },
    alternates: {
        canonical: "https://www.jeckukas.org.in/jec/Institution-Innovation-Council-JEC",
    },
};
